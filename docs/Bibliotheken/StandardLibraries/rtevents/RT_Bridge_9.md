...
## Einleitung
Der RT_Bridge_9 Funktionsblock dient als Entkopplungsbrücke für 9 Datenverbindungen zwischen Echtzeit-Ereignisketten.
...
### **Daten-Eingänge**
- **SD_1** - **SD_9** (ANY): Eingangsdaten.

### **Daten-Ausgänge**
- **RD_1** - **RD_9** (ANY): Ausgangsdaten.
