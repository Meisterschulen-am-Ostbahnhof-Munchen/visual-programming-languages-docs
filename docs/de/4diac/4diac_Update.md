...
|---------|-----------------------------------------------------------------|-----------|--------------------------------------------------------------|
| develop | [Branch ansehen](https://github.com/eclipse-4diac/4diac-ide/tree/develop) | nightly   | [Download](https://download.eclipse.org/4diac/updates/nightly)   |
| freeze  | [Branch ansehen](https://github.com/eclipse-4diac/4diac-ide/tree/freeze)  | milestone | [Download](https://download.eclipse.org/4diac/updates/milestone) |
| 3.0.x   | [Branch ansehen](https://github.com/eclipse-4diac/4diac-ide/tree/3.0.x)   | RC        | [Download](https://download.eclipse.org/4diac/updates/rc)        |
| release | [Branch ansehen](https://github.com/eclipse-4diac/4diac-ide/tree/release) | latest    | [Download](https://download.eclipse.org/4diac/updates/latest)    |
...
2. Navigieren zu: Install/Update → Available Software Sites
3. Für verschiedene Versionen:
   ...
   - weiter URLs sind unten aufgeführt
