...
HR Agrartechnik GmbH). Es ist ein generischer Funktionsbaustein für Addition mit 4 Eingängen,
der sich wie das Standard-`ADD_4` verhält, aber einen Overflow nie unbemerkt
...
`ADD_4` selbst, bei Integer-Typen) bei Overflow den in IEC 61131-3 spezifizierten
...
`SAFE_ADD_4` wird als strikte, von links nach rechts gefaltete Kette einzelner Zweier-Operationen
...
Beispiel (INT, IN1=20000, IN2=20000, IN3=-30000, IN4=0): das wahre Ergebnis wäre `10000`, locker innerhalb des
...
(nicht-sichere) `ADD_4` es auch tut, und meldet eine echte Zwischen-Grenzwertverletzung statt
...
- [ADD_4](../../../StandardLibraries/iec61131-3/arithmetic/ADD_4.md) — das
...
SAFE_ADD_4 bietet dieselbe Addition mit 4 Eingängen wie `ADD_4`, aber mit einem
