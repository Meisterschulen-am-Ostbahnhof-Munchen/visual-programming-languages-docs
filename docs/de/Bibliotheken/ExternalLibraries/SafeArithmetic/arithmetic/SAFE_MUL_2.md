...
**SAFE_MUL_2** ist Teil der **SafeArithmetic**-Bibliothek (`SafeArithmetic::arithmetic`, EPL-2.0,
HR Agrartechnik GmbH). Es ist ein generischer Funktionsbaustein für Multiplikation mit 2 Eingängen,
der sich wie das Standard-`F_MUL` verhält, aber einen Overflow nie unbemerkt
...
- [F_MUL](../../../StandardLibraries/iec61131-3/arithmetic/F_MUL.md) — das
...
SAFE_MUL_2 bietet dieselbe Multiplikation mit 2 Eingängen wie `F_MUL`, aber mit einem
