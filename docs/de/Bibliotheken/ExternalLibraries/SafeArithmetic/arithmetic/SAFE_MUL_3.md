...
**SAFE_MUL_3** ist Teil der **SafeArithmetic**-Bibliothek (`SafeArithmetic::arithmetic`, EPL-2.0,
HR Agrartechnik GmbH). Es ist ein generischer Funktionsbaustein für Multiplikation mit 3 Eingängen,
der das feste 2-Eingänge-`F_MUL` der Standardbibliothek auf 3 Eingänge erweitert (die
...
`SAFE_MUL_3` wird als strikte, von links nach rechts gefaltete Kette einzelner Zweier-Operationen
...
Beispiel (INT, IN1=40000, IN2=40000, IN3=0): das wahre Ergebnis wäre `0`, locker innerhalb des
...
SAFE_MUL_3 erweitert die Multiplikation von `F_MUL` auf 3 Eingänge, mit einem
