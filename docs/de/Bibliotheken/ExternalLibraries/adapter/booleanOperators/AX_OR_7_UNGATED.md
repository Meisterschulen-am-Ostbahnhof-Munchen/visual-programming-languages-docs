...
Der AX_OR_7_UNGATED Funktionsblock ist ein generischer Baustein zur Berechnung der booleschen ODER-Verknüpfung. Er verfügt über sieben Eingänge und berechnet das logische ODER aller Eingangssignale.
...
Da es sich um einen rein kombinatorischen Baustein ohne Ereignissteuerung handelt, besitzt der AX_OR_7_UNGATED keine Zustandsmaschine. Die Ausgabe wird direkt aus den aktuellen Eingangswerten berechnet.
...
Der AX_OR_7_UNGATED ist ein spezialisierter ODER-Baustein für Anwendungen mit vielen Eingangssignalen. Durch die sieben Eingänge und die Adapter-basierte Schnittstelle eignet er sich besonders für komplexe Steuerungsaufgaben, bei denen mehrere Signale logisch verknüpft werden müssen.
