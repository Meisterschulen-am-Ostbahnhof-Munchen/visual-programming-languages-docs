...
Der AX_SPLIT_6_UNGATED Funktionsblock ist ein generischer Baustein, der dazu dient, einen einzelnen AX-Adapter in sechs separate AX-Ausgänge aufzuteilen. Der Baustein ermöglicht die Verteilung von Signalen und Datenströmen von einer zentralen Quelle zu mehreren Verbrauchern.
...
Im Vergleich zu anderen Splitter-Bausteinen bietet AX_SPLIT_6_UNGATED eine feste Anzahl von sechs Ausgängen, was für spezifische Anwendungsfälle vorteilhaft ist. Andere Splitter können variabel mehr oder weniger Ausgänge bieten, sind aber möglicherweise komplexer in der Konfiguration.

Vergleich mit [E_SPLIT](../../../../../StandardLibraries/events/E_SPLIT.md)

- **[`AX_SPLIT_6`](AX_SPLIT_6.md)**: Die gegatete Variante – aktualisiert den Ausgang nur bei tatsächlicher Wertänderung.
