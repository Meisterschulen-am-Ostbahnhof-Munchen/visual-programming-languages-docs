...
- **Generische Splitter anderer Adaptertypen (z. B. Daten-basiert)**: Im Gegensatz zu Daten-Ereignis-Splittern arbeitet AUI_SPLIT_9_UNGATED rein auf Adapterebene und benötigt keine Ereignissteuerung, was den Implementierungsaufwand reduziert.

- **[`AUI_SPLIT_9`](AUI_SPLIT_9.md)**: Die gegatete Variante – aktualisiert den Ausgang nur bei tatsächlicher Wertänderung.
