...
- **[`AUDI_DIV_2`](AUDI_DIV_2.md)**: Die gegatete Variante – aktualisiert den Ausgang nur bei tatsächlicher Wertänderung.
...
Der `AUDI_DIV_2_UNGATED` ist ein moderner, adapterbasierter Funktionsbaustein für die IEC 61499. Er eignet sich hervorragend für komplexe Projekte in der 4diac-ide, bei denen ein hoher Wert auf Übersichtlichkeit, Kapselung und einfache Wartbarkeit des Applikationsdiagramms gelegt wird.
