...
Im Vergleich zu einem klassischen, nicht-generischen IEC 61131-3 `MUL`-Standardbaustein bietet der `AUI_MUL_3_UNGATED`:

- **Weniger Kaskadierung:** Standard-Multiplizierer besitzen oft nur zwei Eingänge. Um drei Werte zu multiplizieren, müssten zwei Bausteine kaskadiert werden. `AUI_MUL_3_UNGATED` erledigt dies in einem Schritt.
...
- **[`AUI_MUL_3`](AUI_MUL_3.md)**: Die gegatete Variante – aktualisiert den Ausgang nur bei tatsächlicher Wertänderung.
