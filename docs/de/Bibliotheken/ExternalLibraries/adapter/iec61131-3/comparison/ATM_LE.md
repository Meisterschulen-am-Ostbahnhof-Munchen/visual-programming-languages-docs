...
- **Normkonformität**: Der Baustein implementiert die Vergleichsfunktion aus IEC 61131-3 („less than or equal to“) für den Datentyp `TIME`.
...
- **Steuerungslogik**: Auslösen einer Aktion, sobald zwei Werte vom Typ `TIME` die Bedingung „kleiner gleich“ erfüllen.
- **Datenfilterung**: Auswählen von Datensätzen oder Signalen, die eine Vergleichsbedingung auf `TIME`-Basis erfüllen.

## Vergleich mit ähnlichen Bausteinen

- **ATM_GE**: Prüft auf „größer gleich“ – invers zur Funktion von ATM_LE.
- **ATM_EQ**: Prüft auf Gleichheit der Werte.
- **ATM_LT**: Führt den Vergleich „kleiner als“ durch – die Basisvariante ohne Gleichheitsfall, deren erweiterte Version ATM_LE ist.

Der ATM_LE ergänzt die ATM-Vergleichsfamilie um den Grenzfall der Gleichheit.

## Fazit

Der **ATM_LE** ist ein einfacher, aber wichtiger Vergleichsbaustein für IEC 61131-3 Steuerungsanwendungen mit dem Datentyp `TIME`. Seine adapterorientierte Schnittstelle macht ihn vielseitig einsetzbar und ermöglicht eine klare Trennung von Ereignis- und Datenpfaden. Durch die ereignisgesteuerte Arbeitsweise eignet er sich besonders für Echtzeitsysteme, in denen Bedingungen sofort auf Werteänderungen reagiert werden müssen.
