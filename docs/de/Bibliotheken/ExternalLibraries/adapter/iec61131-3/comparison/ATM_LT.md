...
- **Normkonformität**: Der Baustein implementiert die Vergleichsfunktion aus IEC 61131-3 („less than“) für den Datentyp `TIME`.
...
- **Steuerungslogik**: Auslösen einer Aktion, sobald zwei Werte vom Typ `TIME` die Bedingung „kleiner als“ erfüllen.
- **Datenfilterung**: Auswählen von Datensätzen oder Signalen, die eine Vergleichsbedingung auf `TIME`-Basis erfüllen.

## Vergleich mit ähnlichen Bausteinen

- **ATM_GT**: Prüft auf „größer als“ – invers zur Funktion von ATM_LT.
- **ATM_EQ**: Prüft auf Gleichheit der Werte.
- **ATM_LE**: Führt den Vergleich „kleiner gleich“ durch – die um den Gleichheitsfall erweiterte Version von ATM_LT.

Der ATM_LT ist die grundlegende „kleiner als“-Komponente ohne Gleichheitsfall, ergänzt durch ATM_LE.

## Fazit

Der **ATM_LT** ist ein einfacher, aber wichtiger Vergleichsbaustein für IEC 61131-3 Steuerungsanwendungen mit dem Datentyp `TIME`. Seine adapterorientierte Schnittstelle macht ihn vielseitig einsetzbar und ermöglicht eine klare Trennung von Ereignis- und Datenpfaden. Durch die ereignisgesteuerte Arbeitsweise eignet er sich besonders für Echtzeitsysteme, in denen Bedingungen sofort auf Werteänderungen reagiert werden müssen.
