...
-   **Bausteine mit variabler Eingangsanzahl:** Einige Bibliotheken bieten XOR-Blöcke an, denen dynamisch Eingänge hinzugefügt werden können. `XOR_BOOL_10` hat eine feste, dafür explizit deklarierte Schnittstelle, was die Code-Analyse vereinfachen kann.
