...
-   **Standard XOR-Bausteine (z.B., XOR, E_XOR):** Diese haben typischerweise nur zwei Eingänge. `XOR_BOOL_9` erweitert diese Funktion auf bis zu neun Eingänge in einem einzigen Baustein.
