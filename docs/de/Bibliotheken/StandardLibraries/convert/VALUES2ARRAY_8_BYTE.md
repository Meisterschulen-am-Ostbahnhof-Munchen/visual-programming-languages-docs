...
- `IN_1`, `IN_2`, `IN_3`, `IN_4`, `IN_5`, `IN_6`, `IN_7`, `IN_8` (`BYTE`): Die 8 einzelnen Werte (8-Bit-Bitmuster), die zum Array zusammengefasst werden.

### **Daten-Ausgänge**

- **OUT** (`BYTE`, Array-Größe 8): `OUT[i-1]` entspricht `IN_i`.
...
- **Feste Größe 8**: Für andere Array-Größen desselben Typs siehe `VALUES2ARRAY_2_BYTE`, `VALUES2ARRAY_4_BYTE`, `VALUES2ARRAY_16_BYTE`, `VALUES2ARRAY_32_BYTE`.
...
- **`ARRAY2VALUES_8_BYTE`**: die Umkehrrichtung — zerlegt ein Array in 8 Einzelwerte.

## Fazit

`VALUES2ARRAY_8_BYTE` liefert eine einfache, generisch implementierte Zusammenführung von 8 `BYTE`-Einzelwerten zu einem Array und eignet sich zur Anpassung variablenbasierter an array-basierte Schnittstellen.
