...
- **D1** (`BYTE`, Array-Größe 512, Index 0…511): Der Array-Container (8-Bit-Bitmuster je Element). Kann im FB-Instanzeditor mit Startwerten vorbelegt werden (z. B. `[16#01, 16#00, ...]` für `BYTE`).
...
- **Feste Größe 512**: Weitere Größen derselben oder anderer Datentypen: `PROVIDE_ARR_0002_BYTE`, `PROVIDE_ARR_0007_BYTE`, `PROVIDE_ARR_0008_BYTE`, `PROVIDE_ARR_0014_BYTE`.
...
`PROVIDE_ARR_0512_BYTE` liefert einen einfachen, zur Entwurfszeit vorbelegbaren `BYTE`-Array-Container fester Größe 512 und eignet sich für Konfigurations- und Testdatenarrays, die wiederverwendbar in 4diac-Applikationen eingebunden werden sollen.
