...
`GreenWhiteBackground2_AXC` ist ein **Kompakt-Wrapper** um [`GreenWhiteBackground2_AX`](GreenWhiteBackground2_AX.md) — reicht `u16ObjId` und den Selector durch, ohne die `CNF`-Ereignisausgänge und Diagnosewerte (`STATUS_n`, `u8OldColour_n`, `result_n`) nach außen zu führen.
