...
Since it is a purely combinational function block without event control, the AX_OR_7 does not have a state machine. The output is calculated directly from the current input values.
