...
1. This event is then passed to the plug plug `AW_OUT.E1`. The converted WORD value (output `OUT` of the converter) is simultaneously applied to the data input `AW_OUT.D1`.
