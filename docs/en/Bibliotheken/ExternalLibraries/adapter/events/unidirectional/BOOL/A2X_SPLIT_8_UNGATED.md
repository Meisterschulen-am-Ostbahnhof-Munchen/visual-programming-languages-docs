...
> ℹ️ **UNGATED variant:** This block is the ungated version of [`A2X_SPLIT_8`](A2X_SPLIT_8.md). It suppresses **no** unchanged repeats – every newly computed result is forwarded unconditionally, even without a value change. This matters for consumers that need a periodic cadence regardless of value change (e.g. derivative/frequency calculations that would otherwise fail to decay toward zero). Any change-detection/gating statements further down this page do **not** apply to this block.
...
The A2X_SPLIT_8_UNGATED function block serves as a generic building block to distribute an incoming A2X adapter (socket) to eight identical A2X adapter outputs (plugs). It is used in industrial automation when a signal is required multiple times.
...
The A2X_SPLIT_8_UNGATED is a simple yet useful function block for multiplying A2X signals in automation projects. Its generic design and clear separation of inputs and outputs provide a clean and reusable solution.
