...
> ℹ️ **UNGATED variant:** This block is the ungated version of [`AB_SPLIT_7`](AB_SPLIT_7.md). It suppresses **no** unchanged repeats – every newly computed result is forwarded unconditionally, even without a value change. This matters for consumers that need a periodic cadence regardless of value change (e.g. derivative/frequency calculations that would otherwise fail to decay toward zero). Any change-detection/gating statements further down this page do **not** apply to this block.
...
- **AB_MERGE**: Merges multiple incoming adapters into one output – the opposite function to AB_SPLIT_7_UNGATED.
- **AB_SPLIT_N**: Generalization with a configurable number of outputs, if available. AB_SPLIT_7_UNGATED is a fixed 1:7 split.
