...
The function block **ADI_SPLIT_5** receives an ADI adapter via the socket **IN** and forwards the data and events it contains in parallel to the five plugs **OUT1** to **OUT5**. No processing or transformation of the data takes place – the block functions as a passive distributor (fan-out).
