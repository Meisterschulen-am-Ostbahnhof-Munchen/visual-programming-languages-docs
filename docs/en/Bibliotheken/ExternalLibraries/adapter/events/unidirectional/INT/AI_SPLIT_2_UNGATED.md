...
> ℹ️ **UNGATED variant:** This block is the ungated version of [`AI_SPLIT_2`](AI_SPLIT_2.md). It suppresses **no** unchanged repeats – every newly computed result is forwarded unconditionally, even without a value change. This matters for consumers that need a periodic cadence regardless of value change (e.g. derivative/frequency calculations that would otherwise fail to decay toward zero). Any change-detection/gating statements further down this page do **not** apply to this block.
...
The AI_SPLIT_2_UNGATED function block is used to distribute an analog input signal (AI) to two identical analog outputs. It is designed as a generic function block and allows for flexible further processing of the signal in two independent paths.
...
AI_SPLIT_2_UNGATED is specialized for simple 1:2 distribution without logic or configuration.
...
AI_SPLIT_2_UNGATED is a simple yet useful function block for passively splitting an analog input signal. Its generic adapter approach makes it flexible and facilitates the modular structuring of applications according to IEC 61499.
