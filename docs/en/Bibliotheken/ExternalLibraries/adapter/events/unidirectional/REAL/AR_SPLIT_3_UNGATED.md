...
> ℹ️ **UNGATED variant:** This block is the ungated version of [`AR_SPLIT_3`](AR_SPLIT_3.md). It suppresses **no** unchanged repeats – every newly computed result is forwarded unconditionally, even without a value change. This matters for consumers that need a periodic cadence regardless of value change (e.g. derivative/frequency calculations that would otherwise fail to decay toward zero). Any change-detection/gating statements further down this page do **not** apply to this block.
...
Unlike dedicated splitters with data or event inputs/outputs, the `AR_SPLIT_3_UNGATED` operates exclusively via adapters, making it particularly flexible and type-independent.
