...
> ℹ️ **UNGATED variant:** This block is the ungated version of [`AR_SPLIT_6`](AR_SPLIT_6.md). It suppresses **no** unchanged repeats – every newly computed result is forwarded unconditionally, even without a value change. This matters for consumers that need a periodic cadence regardless of value change (e.g. derivative/frequency calculations that would otherwise fail to decay toward zero). Any change-detection/gating statements further down this page do **not** apply to this block.
...
The function block **AR_SPLIT_6_UNGATED** is used to distribute a single AR adapter input to six separate AR adapter outputs. It is designed as a generic function block (Generic FB) and allows for the simple duplication of an AR interface without data loss or protocol-specific conversion.
...
- **AR_SPLIT_2 / AR_SPLIT_4:** These function blocks split the input into two or four outputs, respectively, and differ only in the number of outputs. AR_SPLIT_6_UNGATED extends this to six outputs.
...
The **AR_SPLIT_6_UNGATED** is a simple yet useful generic function block for multiplying an AR adapter signal into six parallel outputs. It is characterized by minimal complexity, a clear structure, and high reusability in automation projects based on the 4diac IDE and the IEC 61499 standard.
