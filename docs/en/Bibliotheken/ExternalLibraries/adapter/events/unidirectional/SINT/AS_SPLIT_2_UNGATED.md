...
The **AS_SPLIT_2_UNGATED** is a simple yet useful function block for duplicating adapter data streams. Its generic definition and the absence of complex logic make it ideally suited as a universal distribution element in 4diac-based automation systems where signal splitting without data modification is required.
