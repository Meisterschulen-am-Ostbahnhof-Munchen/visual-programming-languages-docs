...
> ℹ️ **UNGATED variant:** This block is the ungated version of [`AUDI_SPLIT_3`](AUDI_SPLIT_3.md). It suppresses **no** unchanged repeats – every newly computed result is forwarded unconditionally, even without a value change. This matters for consumers that need a periodic cadence regardless of value change (e.g. derivative/frequency calculations that would otherwise fail to decay toward zero). Any change-detection/gating statements further down this page do **not** apply to this block.
...
- **[`AUDI_SPLIT_3`](AUDI_SPLIT_3.md)**: The gated variant – updates the output only on an actual value change.
