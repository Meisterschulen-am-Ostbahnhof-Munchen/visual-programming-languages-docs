...
> ℹ️ **UNGATED variant:** This block is the ungated version of [`AUDI_SPLIT_8`](AUDI_SPLIT_8.md). It suppresses **no** unchanged repeats – every newly computed result is forwarded unconditionally, even without a value change. This matters for consumers that need a periodic cadence regardless of value change (e.g. derivative/frequency calculations that would otherwise fail to decay toward zero). Any change-detection/gating statements further down this page do **not** apply to this block.
...
The function block **AUDI_SPLIT_8_UNGATED** is used to distribute an incoming unidirectional **AUDI** adapter signal to eight parallel outputs.
...
- **Simple Split FB (e.g., SPLIT_2)**: Distributes a signal to two outputs – AUDI_SPLIT_8_UNGATED offers eight outputs in a single module.
...
**AUDI_SPLIT_8_UNGATED** is a compact, generic, specialized module for signal distribution at the adapter level.
