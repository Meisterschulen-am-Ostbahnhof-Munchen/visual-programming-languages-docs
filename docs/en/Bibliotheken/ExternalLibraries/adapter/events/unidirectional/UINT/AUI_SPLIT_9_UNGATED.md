...
> ℹ️ **UNGATED variant:** This block is the ungated version of [`AUI_SPLIT_9`](AUI_SPLIT_9.md). It suppresses **no** unchanged repeats – every newly computed result is forwarded unconditionally, even without a value change. This matters for consumers that need a periodic cadence regardless of value change (e.g. derivative/frequency calculations that would otherwise fail to decay toward zero). Any change-detection/gating statements further down this page do **not** apply to this block.
...
- **Generic Splitters of Other Adapter Types (e.g., Data-Based)**: Unlike data-event splitters, AUI_SPLIT_9_UNGATED operates purely at the adapter level and requires no event control, thus reducing implementation effort.
