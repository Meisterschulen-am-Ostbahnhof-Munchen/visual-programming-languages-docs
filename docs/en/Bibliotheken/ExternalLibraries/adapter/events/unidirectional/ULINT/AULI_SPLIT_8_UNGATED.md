...
The 4diac IDE often includes blocks such as `SPLIT_2`, `SPLIT_4`, or generic split blocks for event/data lines. `AULI_SPLIT_8_UNGATED` specializes in this for the AULI adapter and offers a compact 1:8 distribution without additional data type conversion. Compared to manually chaining simpler split blocks, it reduces wiring complexity and improves clarity.

- **[`AULI_SPLIT_8`](AULI_SPLIT_8.md)**: The gated variant – updates the output only on an actual value change.
