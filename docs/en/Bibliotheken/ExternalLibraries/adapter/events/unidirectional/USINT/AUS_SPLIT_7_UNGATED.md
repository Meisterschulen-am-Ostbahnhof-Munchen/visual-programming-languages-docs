...
> ℹ️ **UNGATED variant:** This block is the ungated version of [`AUS_SPLIT_7`](AUS_SPLIT_7.md). It suppresses **no** unchanged repeats – every newly computed result is forwarded unconditionally, even without a value change. This matters for consumers that need a periodic cadence regardless of value change (e.g. derivative/frequency calculations that would otherwise fail to decay toward zero). Any change-detection/gating statements further down this page do **not** apply to this block.
...
- **AUS_SPLIT_N** (e.g., for 2, 4, or 8 outputs) exist in variants with different numbers of outputs. AUS_SPLIT_7_UNGATED is a specific variant for exactly seven outputs.
...
- Function blocks with event interfaces (e.g., `E_SPLIT`) distribute events, not signals. AUS_SPLIT_7_UNGATED, on the other hand, distributes a continuous signal value.
