...
The function block **AIWS_SPLIT_8_UNGATED** splits an incoming AIWS adapter signal into eight identical outputs. It functions as a generic splitter for unidirectional adapter connections and enables the parallel forwarding of a signal to multiple subsequent function blocks.
...
**AIWS_SPLIT_8_UNGATED** is a simple yet essential component for multiplying an AIWS adapter signal across eight parallel paths. Its implementation without event-driven control or state logic makes it lightweight and reliable for use in distributed automation systems.
