...
The `AS_ADD_2` is a clean, adapter-based addition block that keeps a two-input arithmetic operation consistent with the rest of the adapter-based `AS` family, making it easy to wire and reuse across IEC 61499 applications.
