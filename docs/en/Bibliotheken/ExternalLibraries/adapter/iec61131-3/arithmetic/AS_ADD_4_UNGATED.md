...
> ℹ️ **UNGATED variant:** This block is the ungated version of [`AS_ADD_4`](AS_ADD_4.md). It suppresses **no** unchanged repeats – every newly computed result is forwarded unconditionally, even without a value change. This matters for consumers that need a periodic cadence regardless of value change (e.g. derivative/frequency calculations that would otherwise fail to decay toward zero). Any change-detection/gating statements further down this page do **not** apply to this block.
...
The `AS_ADD_4_UNGATED` is a specialized, highly efficient function block for modern, adapter-based programming in the 4diac IDE. It is ideally suited for applications that require a high degree of modularity and clarity in the signal flow and need to add four summands cleanly and efficiently.
