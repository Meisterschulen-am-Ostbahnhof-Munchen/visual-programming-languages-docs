...
The primary function of `AUS_SUB_2` is arithmetic subtraction:
...
The `AUS_SUB_2` is a specialized yet flexible subtraction function block. Through the consistent use of unidirectional adapters, it promotes a clean, structured, and clear design of control programs in the 4diac IDE.