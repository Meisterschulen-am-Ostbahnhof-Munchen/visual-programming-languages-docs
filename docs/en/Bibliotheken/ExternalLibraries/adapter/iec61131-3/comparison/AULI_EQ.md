...
- **Standard compliance**: The function block implements the comparison function from IEC 61131-3 ("equal to") for the `ULINT` data type.
...
- **Control Logic**: Triggering an action once two values of type `ULINT` satisfy the "equal to" condition.
- **Data Filtering**: Selecting data records or signals that satisfy a `ULINT`-based comparison condition.

## Comparison with Similar Function Blocks

- **AULI_NE**: Checks for "not equal to" – the inverse function of AULI_EQ.
- **AULI_NE**: Checks for inequality of values.

AULI_EQ is part of the complete AULI comparison family (EQ/NE/GT/GE/LT/LE) for the `ULINT` data type.
