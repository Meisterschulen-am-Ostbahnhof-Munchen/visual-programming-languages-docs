...
- **OR_2_BOOL:** Combines only two inputs. `OR_3_BOOL` extends this functionality to include a third input. See also: [OR_3](../../../StandardLibraries/iec61131-3/bitwiseOperators/OR_3.md)
- **GEN_OR:** The underlying generic function block, which can be configured for a variable number of inputs. `OR_3_BOOL` is a specific instance of this, fixed to three inputs.
