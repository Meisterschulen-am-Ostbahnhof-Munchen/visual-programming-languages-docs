...
- **XOR (2 Inputs):** The standard XOR block with only two inputs. `XOR_BOOL_3` extends this function to three operands. See: [XOR_3](../../../StandardLibraries/iec61131-3/bitwiseOperators/XOR_3.md)
