...
that does not send an address claimed message.
An address claimed message from an external CF with the same source address
will replace this manual added member entry.
The function works independently from the configuration of the #CFG_PARAM_EXTERNAL_ADDR_CLAIM parameter.
