...
## Introduction
The X20DI9371 function block is used to read digital signals via the openPOWERLINK fieldbus. It corresponds to the B&R X20DI9371 digital input module (12 channels).
