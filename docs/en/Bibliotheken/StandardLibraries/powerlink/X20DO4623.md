...
The X20DO4623 function block is used to control digital outputs via the openPOWERLINK fieldbus. It corresponds to the B&R X20DO4623 digital output module (4 channels).
