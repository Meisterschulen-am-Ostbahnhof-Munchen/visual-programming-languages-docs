...
The X20DO9321 function block is used to control digital outputs via the openPOWERLINK fieldbus. It corresponds to the B&R X20DO9321 digital output module (12 channels).
