...
myst:
  ...
  html_meta:
    "description lang=en": "Documentation for visual programming languages and IEC 61499"
    "keywords": "IEC 61499, 4diac, PLC, Automation, Visual Programming"
...
**Welcome to the documentation on visual programming languages.**
...
- 📚 **[Wiki 4.1: 4diac Function Block & Adapter Library Reference](https://meisterschulen-am-ostbahnhof-munchen-docs.readthedocs.io/projects/4diac-library-reference-docs-en/en/latest/)** (moved out of this wiki to keep builds fast)
- 📝 **[Wiki 4.2: Exercises – 4diac Training Solutions](https://meisterschulen-am-ostbahnhof-munchen-docs.readthedocs.io/projects/4diac-exercises-docs-en/en/latest/)** (moved out of this wiki to keep builds fast)

---

Welcome to the world of graphical programming! This documentation provides a comprehensive introduction to the concepts of visual programming, with a special focus on industrial automation according to **IEC 61499**.
...
!!! note
    This project is under active development. Questions or suggestions?
    Visit our [Discussion Forum](https://github.com/Meisterschulen-am-Ostbahnhof-Munchen/visual-programming-languages-docs/discussions).
