...
#### Task: Flip-Flops and Equals

The designer calls; he now wants to be able to turn off the desk lamp separately. As before, a double-click should turn off both lamps, while a triple-click should turn off only the desk lamp.

### Flip-Flops and Logic Functions

#### Task: Flip-Flops and Logic Functions

A freight elevator has two functions: Up (Q1) and Down (Q2). Three buttons control the elevator: Up (I1), Down (I2), and Stop (I3). Outputs Q1 and Q2 must never be pressed simultaneously, otherwise the motor will burn out. The Stop button must always be pressed before changing direction.

### Flip-Flops and E Functions
