...
## Einleitung
Der **E_R_TRIG** (Rising Edge Trigger) ist ein grundlegender Funktionsbaustein nach IEC 61499 zur Erkennung steigender Flanken in digitalen Signalen. Basierend auf der XML-Spezifikation von fortiss GmbH implementiert er eine zuverlässige Flankendetektion für industrielle Steuerungssysteme.
...
Der E_R_TRIG-Baustein nach der fortiss-Spezifikation bietet eine robuste Lösung für Flankendetektionsaufgaben in industriellen Steuerungssystemen. Seine wesentlichen Vorteile sind:
