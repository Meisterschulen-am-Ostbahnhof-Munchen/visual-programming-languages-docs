...
### XML-Implementierungsausschnitt
```xml
<BasicFB>
  <ECC>
    <ECState Name="START">
      <ECTransition Condition="EI0[NOT G]" Destination="EO"/>
      <ECTransition Condition="EI1[G]" Destination="EO"/>
    </ECState>
    <ECState Name="EO">
      <ECAction Output="EO"/>
      <ECTransition Destination="START"/>
    </ECState>
  </ECC>
</BasicFB>
```
